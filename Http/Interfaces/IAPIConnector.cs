...
namespace SpaceTradersDotNetSDK.Http
{
  public interface IAPIConnector
  {
    ...
    Task<T> Patch<T>(Uri uri, CancellationToken cancel = default);
    Task<T> Patch<T>(Uri uri, IDictionary<string, string>? parameters, CancellationToken cancel = default);
    Task<T> Patch<T>(Uri uri, IDictionary<string, string>? parameters, object? body, CancellationToken cancel = default);
    Task<T> Patch<T>(Uri uri, IDictionary<string, string>? parameters, object? body, Dictionary<string, string>? headers, CancellationToken cancel = default);
    Task<HttpStatusCode> Patch(Uri uri, IDictionary<string, string>? parameters, object? body, CancellationToken cancel = default);
